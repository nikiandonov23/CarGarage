...
namespace CarGarage.Data.Migrations
{
    ...
    [Migration("20260926155119_AddCarImagesRelations")]
    partial class AddCarImagesRelations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CarGarage.DataModels.CarImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CarGarage.DataModels.ForumComment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CarGarage.DataModels.ForumPost", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CarGarage.DataModels.ForumPostLike", b =>
                {
                    b.Property<int>("PostId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CarGarage.DataModels.Invoice", b =>
                {
                    ...
                    b.Property<decimal>("LaborPricePerHour")
            ...
            modelBuilder.Entity("CarGarage.DataModels.PartForSale", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CarGarage.DataModels.ForumComment", b =>
                {
                    b.HasOne("CarGarage.DataModels.ForumPost", "Post")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("CarGarage.DataModels.Offer", b =>
                {
                    b.HasOne("CarGarage.DataModels.PartForSale", "PartForSale")
                        .WithMany()
                        .HasForeignKey("PartForSaleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("PartForSale");
                });
            ...
            modelBuilder.Entity("CarGarage.DataModels.Part", b =>
                {
                    ...
                    b.HasOne("CarGarage.DataModels.Invoice", "Invoice")
                        .WithMany("Parts")
